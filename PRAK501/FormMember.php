...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        print_r($_POST);
        tambahmember($_POST['nama'], $_POST['nomor_member'], $_POST['alamat'], $tanggaldaftar, $_POST['tgl_terakhir_bayar']);
    }
    if (isset($_POST['update'])) {
        $tanggaldaftar = date('Y-m-d H:i:s', strtotime($_POST['tanggaldaftar']));
        updatemember($_GET['id_member'], $_POST['nama'], $_POST['nomor_member'], $_POST['alamat'], $tanggaldaftar, $_POST['tgl_terakhir_bayar']);
    }
    ?>
</body>
</html>